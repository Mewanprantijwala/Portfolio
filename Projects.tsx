...
export const Projects = () => {
  ...
  const projects: Project[] = [
    {
      id: 1,
      title: "Ammachi kitchen ",
      description: "Ammachi kitchen is a web application that allows users to order food from a restaurant. The application is built using React, TypeScript, Node.js, and PostgreSQL.",
      image: "/images/AMMACHI.png",
      technologies: ["React", "TypeScript", "Node.js", "PostgreSQL"],
      category: "Web App",
      githubUrl: "https://github.com/Ammachi-kitchen",
